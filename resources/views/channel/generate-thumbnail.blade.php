    ...
    <div class="row justify-content-center">
      <div class="d-flex p-2">
        ...
        <!--    <div class="card-body">
                ...
                @endif
                <form id="generate-thumnbail-form" method="POST" action="{{route('generate_thumbnail.post')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                            <label for="video" class="col-md-4 col-form-label text-md-end">{{ __('Video') }}</label>

                            <div class="col-md-6">
                                <input id="video" type="file" class="form-control @error('video') is-invalid @enderror" name="video" required autocomplete="video">
